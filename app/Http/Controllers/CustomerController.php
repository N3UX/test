...
class CustomerController extends Controller
{
    ...
    public function store(CustomerStoreRequest $request)
    {
        ...
        return redirect()->route('customers.index')->with('success', 'Has dado de alta al empleado correctamente');
    }
    ...
    public function update(Request $request, Customer $customer)
    {
        ...
        return redirect()->route('customers.index')->with('success', 'Has actualizado la información del empleado correctamente');
    }
